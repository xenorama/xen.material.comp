...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 880.0, 119.0, 50.0, 22.0 ],
					"varname" : "dim[1]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 796.0, 119.0, 50.0, 22.0 ],
					"varname" : "dim[0]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 796.0, 151.0, 103.0, 22.0 ],
					"text" : "pak 256 256",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 796.0, 183.0, 95.0, 22.0 ],
					"text" : "dim $1 $2, bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 100.0, 677.71698135137558, 67.0, 22.0 ],
					"text" : "universal 1",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 100.0, 645.71698135137558, 163.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 557.714285714285779, 183.0, 80.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 606.14285714285711, 677.0, 194.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 606.14285714285711, 709.0, 69.0, 22.0 ],
					"text" : "jit.gl.handle",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 452.428571428571445, 393.0, 167.0, 22.0 ],
					"text" : "jit.gl.pix @gen the.normalmap",
					"textcolor" : [ 0.875832, 0.744178, 0.0336, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 349.0, 767.0, 245.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 349.0, 740.0, 276.14285714285711, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 368.5, 645.71698135137558, 102.0, 76.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "xen.material.vtf_normals.gl.pix"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.523824896131373, 104.999991178512573, 339.66666567325592, 21.0 ],
					"text" : "Calculate a normal map from a heightmap using jit.gl.pix",
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 805.5, 634.85849067568779, 378.0, 634.85849067568779 ],
					"order" : 1,
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 1.0, 0.984314, 0.870588, 0.0 ],
					"destination" : [ "obj-4", 0 ],
					"midpoints" : [ 805.5, 216.0, 512.214285714285666, 216.0 ],
					"order" : 0,
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 378.0, 626.0, 615.64285714285711, 626.0 ],
					"order" : 0,
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 512.214285714285666, 167.5, 567.214285714285779, 167.5 ],
					"order" : 0,
					"source" : [ "obj-7", 1 ]
				}
