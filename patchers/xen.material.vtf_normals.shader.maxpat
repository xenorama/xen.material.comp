...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 665.0, 253.0, 50.0, 22.0 ],
					"varname" : "dim[1]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 581.0, 253.0, 50.0, 22.0 ],
					"varname" : "dim[0]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 581.0, 285.0, 103.0, 22.0 ],
					"text" : "pak 256 256",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 581.0, 317.0, 95.0, 22.0 ],
					"text" : "dim $1 $2, bang"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 985.0, 278.0, 50.0, 22.0 ],
					"varname" : "scale_coeff"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 807.0, 317.0, 197.0, 35.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 807.0, 160.0, 20.0, 140.0 ],
					"size" : 1.0,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 807.0, 361.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 723.0, 777.0, 56.0, 22.0 ],
					"restore" : 					{
						"dim[0]" : [ 256 ],
						"dim[1]" : [ 256 ],
						"normal_scale" : [ 0.753846153846154 ],
						"scale_coeff" : [ 0.37 ]
					}
,
					"text" : "autopattr",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 737.5, 472.0, 141.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 114.5, 203.0, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 882.5, 689.0, 99.0, 22.0 ],
					"text" : "param dim $1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 724.0, 830.0, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 724.0, 895.0, 67.0, 22.0 ],
					"text" : "universal 1",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 724.0, 863.0, 163.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 239.5, 283.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 723.0, 689.0, 134.0, 22.0 ],
					"text" : "param normal_scale $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 402.0, 430.0, 267.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 239.5, 571.0, 327.0, 22.0 ],
					"text" : "jit.gl.texture @name heightmap @rectangle 0 @type float32",
...
, 			{
				"box" : 				{
					...
					"color" : [ 0.852126, 0.764453, 0.085088, 1.0 ],
					"id" : "obj-27",
					"maxclass" : "newobj",
					"numinlets" : 1,
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 723.0, 734.0, 338.0, 22.0 ],
					"text" : "jit.gl.shader @name vtf_normals @file the.mat.vtf_normals.jxs",
					"textcolor" : [ 0.495431, 0.799805, 0.834166, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 239.5, 864.0, 246.0, 47.0 ],
					"style" : "helpfile_label",
					"text" : "vtf_normals requires auto_tangents enabled and a texture as heightmap which is also used to calculate the normals",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 239.5, 811.0, 285.0, 35.0 ],
					"text" : "jit.gl.mesh @auto_tangents 1 @shader vtf_normals @texture heightmap @color 1. 1. 1. 1.",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 106.5, 430.0, 48.0, 22.0 ],
					"text" : "time $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 106.5, 398.0, 105.0, 22.0 ],
					"text" : "accum 0.",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 106.5, 366.0, 62.0, 22.0 ],
					"text" : "t b 0.001",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 239.5, 472.0, 478.0, 22.0 ],
					"text" : "jit.gl.bfg @basis distorted @basis.inner fractal.multi.hybrid @type float32 @scale 0.4 0.4",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_gl_texture", "" ],
					"patching_rect" : [ 239.5, 430.0, 151.0, 22.0 ],
					"text" : "jit.gl.texture @dim 256 256",
					"textcolor" : [ 0.810309, 0.620985, 0.2337, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 502.5, 689.0, 197.0, 35.0 ],
					"text" : "position 0. 0. -1.439673, rotatexyz -66.093491 -37.603573 -14.70735"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 502.5, 756.0, 69.0, 22.0 ],
					"text" : "jit.gl.handle",
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 20.0, 166.0, 40.0, 22.0 ],
									"text" : "* amp"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 21.0, 214.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
,
					"patching_rect" : [ 239.5, 539.0, 250.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 239.5, 609.0, 60.0, 22.0 ],
					"text" : "loadbang",
					"textcolor" : [ 0.0, 0.0, 0.0, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 239.5, 694.71698135137558, 102.0, 76.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 279.5, 360.0, 80.0, 35.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 114.5, 240.0, 269.0, 22.0 ],
					"text" : "jit.world normals @enable 1 @floating 1 @fsaa 1",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.523824896131373, 73.999991178512573, 674.0, 6.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 5.523824896131373, 7.999991178512573, 674.0, 64.0 ],
					"text" : "xen.material.vtf_normals.shader"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "adjusted jit.gl.material default shader expecting heightmap to calculate a normalmap in a jit.gl.shader",
					"textcolor" : [ 1.0, 0.984313725490196, 0.870588235294118, 0.5 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 116.0, 461.5, 249.0, 461.5 ],
					"source" : [ "obj-16", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 747.0, 516.0, 249.0, 516.0 ],
					"source" : [ "obj-18", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 590.5, 673.85849067568779, 249.0, 673.85849067568779 ],
					"order" : 0,
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"color" : [ 1.0, 0.984314, 0.870588, 0.0 ],
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 590.5, 417.0, 249.0, 417.0 ],
					"order" : 1,
					"source" : [ "obj-20", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 590.5, 395.5, 892.0, 395.5 ],
					"order" : 0,
					"source" : [ "obj-22", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 816.5, 427.0, 747.0, 427.0 ],
					"order" : 0,
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 816.5, 585.5, 732.5, 585.5 ],
					"order" : 1,
					"source" : [ "obj-28", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 249.0, 336.0, 116.0, 336.0 ],
					"order" : 2,
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 249.0, 333.0, 289.0, 333.0 ],
					"order" : 0,
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 249.0, 368.0, 249.0, 368.0 ],
					"order" : 1,
					"source" : [ "obj-36", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-27", 0 ],
					"midpoints" : [ 892.0, 722.0, 732.5, 722.0 ],
					"source" : [ "obj-56", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 249.0, 652.0, 512.0, 652.0 ],
					"order" : 0,
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 0 ],
					"midpoints" : [ 411.5, 461.5, 249.0, 461.5 ],
					"source" : [ "obj-63", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 249.0, 498.0, 249.0, 498.0 ],
					"source" : [ "obj-8", 0 ]
				}
