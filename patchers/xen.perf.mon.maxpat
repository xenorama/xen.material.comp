...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 245.0, 506.0, 86.0, 22.0 ],
					"text" : "vexpr $f1 * 1.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 245.0, 532.5, 55.0, 22.0 ],
					"text" : "$1 $1 $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 245.0, 565.0, 320.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 245.0, 479.5, 67.0, 22.0 ],
					"text" : "route scale"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 185.0, 262.0, 79.0, 22.0 ],
					"text" : "route dummy"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 132.5, 223.0, 71.5, 22.0 ],
					"text" : "typeroute~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 290.0, 240.0, 66.0, 22.0 ],
					"text" : "route done"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 237.0, 138.0, 72.0, 22.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 108.0, 268.0, 54.0, 22.0 ],
					"text" : "gate 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.0, 171.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 498.0, 473.0, 652.0, 35.0 ],
					"text" : "jit.gl.gridshape #0_perf @shape plane @scale 1.5 0.4 0 @blend_enable 1 @layer 0 @position 1.35 0 0 @color 0 0 0 0.2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 108.0, 300.0, 35.0, 22.0 ],
					"text" : "b 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 179.0, 339.0, 176.0, 49.0 ],
					"text" : "jit.gl.node #1 @name #0_perf @position #2 #3 #4 @blend_enable 1"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 234.0, 197.0, 91.0, 22.0 ],
									"text" : "vec 1 0.98 0.87"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 164.0, 227.0, 89.0, 22.0 ],
									"text" : "mix 0.5"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 164.0, 257.0, 35.0, 22.0 ],
									"text" : "out 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 164.0, 164.0, 26.0, 22.0 ],
									"text" : "!- 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 164.0, 197.0, 62.0, 22.0 ],
									"text" : "vec 0 1 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 164.0, 125.0, 101.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 59.0, 58.0, 41.0, 22.0 ],
									"text" : "swiz x"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 59.0, 22.0, 28.0, 22.0 ],
									"text" : "in 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 22.0, 125.0, 93.0, 22.0 ],
									"text" : "vec snorm.x 0 0"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 22.0, 164.0, 35.0, 22.0 ],
									"text" : "out 1"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-9", 1 ],
									"midpoints" : [ 173.5, 157.5, 195.0, 157.5 ],
									"order" : 0,
									"source" : [ "obj-8", 0 ]
								}
...
,
					"patching_rect" : [ 498.0, 364.0, 41.0, 22.0 ],
					"text" : "jit.gen"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 498.0, 424.0, 405.0, 35.0 ],
					"text" : "jit.gl.mesh #0_perf @draw_mode line_strip @position 1.7 -0.3 0 @color 1 0.98 0.87 0.2 @blend_enable 1 @depth_enable 0 @scale 1 0.6 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 498.0, 330.0, 107.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 498.0, 291.0, 78.0, 22.0 ],
					"text" : "jit./ @val 120"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 498.0, 254.0, 177.0, 22.0 ],
					"text" : "jit.matrix #0_performanceInfo"
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 221.0, 102.0, 82.0, 22.0 ],
									"text" : "vec cell.x-1 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 176.0, 149.0, 64.0, 22.0 ],
									"text" : "nearestpix"
								}
...
,
					"patching_rect" : [ 498.0, 223.0, 41.0, 22.0 ],
					"text" : "jit.gen"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 498.0, 192.0, 243.0, 22.0 ],
					"text" : "jit.matrix #0_performanceInfo 1 float32 66"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 498.0, 161.0, 156.0, 22.0 ],
					"text" : "jit.fill #0_performanceInfo"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 108.0, 371.75, 53.0, 22.0 ],
					"text" : "slide 2 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 108.0, 617.0, 697.0, 22.0 ],
					"text" : "jit.gl.text #0_perf @fontsize 30 @blend_enable 1 @color 1 0.98 0.87 0.2 @depth_enable 0 @position 0 -0.1 0 @fontname Lato"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 108.0, 500.5, 59.0, 22.0 ],
					"text" : "round 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 108.0, 401.5, 54.0, 22.0 ],
					"text" : "qlim 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 108.0, 435.0, 49.0, 22.0 ],
					"text" : "!/ 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "float", "" ],
					"patching_rect" : [ 108.0, 336.0, 35.0, 22.0 ],
					"text" : "timer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 108.0, 171.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 108.0, 531.0, 75.0, 22.0 ],
					"text" : "prepend text"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "simple performance monitor"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 3 ],
					"midpoints" : [ 518.5, 409.5, 652.25, 409.5 ],
					"source" : [ "obj-33", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 117.5, 474.0, 363.5, 474.0, 363.5, 150.0, 507.5, 150.0 ],
					"order" : 0,
					"source" : [ "obj-6", 0 ]
				}
